...
$config = array(
	...
	*/
	...
	//******************
	'delete_files'                            => !empty($_SESSION['RF']['quiz_modifier']),
	'create_folders'                          => !empty($_SESSION['RF']['quiz_modifier']),
	'delete_folders'                          => !empty($_SESSION['RF']['quiz_modifier']),
	'upload_files'                            => !empty($_SESSION['RF']['quiz_modifier']),
	'rename_files'                            => !empty($_SESSION['RF']['quiz_modifier']),
	'rename_folders'                          => !empty($_SESSION['RF']['quiz_modifier']),
	'duplicate_files'                         => !empty($_SESSION['RF']['quiz_modifier']),
	'extract_files'                           => !empty($_SESSION['RF']['quiz_modifier']),
	'copy_cut_files'                          => !empty($_SESSION['RF']['quiz_modifier']), // for copy/cut files
	'copy_cut_dirs'                           => !empty($_SESSION['RF']['quiz_modifier']), // for copy/cut directories
	'chmod_files'                             => !empty($_SESSION['RF']['quiz_modifier']), // change file permissions
	'chmod_dirs'                              => !empty($_SESSION['RF']['quiz_modifier']), // change folder permissions
	'preview_text_files'                      => !empty($_SESSION['RF']['quiz_modifier']), // eg.: txt, log etc.
	'edit_text_files'                         => !empty($_SESSION['RF']['quiz_modifier']), // eg.: txt, log etc.
	'create_text_files'                       => !empty($_SESSION['RF']['quiz_modifier']), // only create files with exts. defined in $config['editable_text_file_exts']
	'download_files'			  => !empty($_SESSION['RF']['quiz_modifier']), // allow download files or just preview
